...
public class BlendEffect extends Application {
    ...
    //@Override
    public void start2(Stage primaryStage) { // Set mode on the pane
        try {
    ...
    public void start1(Stage primaryStage) {
        try {
            ...
            int i = 0;
            grid.addRow(i++, new Text("Cirlce top"), new Text("Square top"));
    ...
    private static class AllBlendEffectsThread extends Thread {
        ...
        "EXCLUSION,OVERLAY", "SCREEN,OVERLAY", "SOFT_LIGHT,HARD_LIGHT", "BLUE,GREEN", "BLUE,RED", "MULTIPLY,SRC_OVER", "SRC_ATOP,SRC_OVER"};
        ...
        public AllBlendEffectsThread(Text txt1, Text txt2, Text txt3, Group g1, Group g2) {
            setDaemon(true);
            this.txt1 = txt1;
            this.txt2 = txt2;
            this.txt3 = txt3;
